# SimpleBilly Scala SDK

[![Release](https://img.shields.io/github/v/release/simplebilly/simplebilly-scala?label=release&logo=github)](https://github.com/simplebilly/simplebilly-scala/releases)
[![CI](https://github.com/simplebilly/simplebilly-scala/actions/workflows/release.yml/badge.svg)](https://github.com/simplebilly/simplebilly-scala/actions/workflows/release.yml)
[![CodeQL](https://github.com/simplebilly/simplebilly-scala/actions/workflows/codeql.yml/badge.svg)](https://github.com/simplebilly/simplebilly-scala/actions/workflows/codeql.yml)
[![Scorecard](https://github.com/simplebilly/simplebilly-scala/actions/workflows/scorecard.yml/badge.svg)](https://github.com/simplebilly/simplebilly-scala/actions/workflows/scorecard.yml)
[![OpenSSF Scorecard](https://api.scorecard.dev/projects/github.com/simplebilly/simplebilly-scala/badge)](https://scorecard.dev/viewer/?uri=github.com/simplebilly/simplebilly-scala)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE)
[![Docs](https://img.shields.io/badge/docs-simplebilly.com-blue)](https://simplebilly.com/api/docs)

Official Scala client for the [SimpleBilly API](https://simplebilly.com/api/docs).
...
> published under [Releases](https://github.com/simplebilly/simplebilly-scala/releases).

## Installation

The package is published to the Scala package registry (and to [GitHub Packages](https://github.com/orgs/simplebilly/packages) for public repos — free for public packages).
See the [Releases](https://github.com/simplebilly/simplebilly-scala/releases) page for the list
