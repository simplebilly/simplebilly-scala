...
case class RecurringTemplateUpdate (
  ...
  executionInterval: Option[String] = None,
  executionStatus: Option[ExecutionStatus] = None,
  ...
  templateType: Option[RecurringTemplateType] = None,
  voucherData: Option[AnyType] = None
) extends ApiModel

object RecurringTemplateUpdateEnums {
