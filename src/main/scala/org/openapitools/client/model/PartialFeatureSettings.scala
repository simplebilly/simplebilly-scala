...
case class PartialFeatureSettings (
  onlineshop: Option[Boolean] = None,
  reportBilanz: Option[Boolean] = None,
  reportBwa: Option[Boolean] = None,
  reportEuer: Option[Boolean] = None,
  reportGewerbesteuer: Option[Boolean] = None,
  reportGuv: Option[Boolean] = None,
  reportKst: Option[Boolean] = None,
  reportUstva: Option[Boolean] = None
) extends ApiModel
